        ...
        <div class="divGridFooter" >
            ...
            <div class="text-footer" >
                <div>
                    ...
                    <h3>Ubicación</h3>
                    <p >
                        Calzada Robledo Industrial 460,
                        Col. Huertas del Colorado,
                        Mexicali, BC 21384, MX
                    </p>
                </div>
                <div></div>
                <div>
                    <i class="bi bi-person-lines-fill h4" style="color:#F1C40F"></i>
                    <h3>Contacto</h3>
                ...
                <div></div>
                <div>
                    <i class="bi bi-clock-fill h4" style="color:#F1C40F"></i>
                    <h3>Horario</h3>
                    <p >
                        Lunes - Viernes: 9.00 h - 18.00 h<br/>
